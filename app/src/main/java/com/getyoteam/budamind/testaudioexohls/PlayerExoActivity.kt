...
//        totalWeeklyMin = meditationStateModelTemp.getWeeklyMinutes() as Int
        ...
        if (isSoundServiceRunning(MusicService::class.java.name)) {
        ...
        broadcastReceiver = object : BroadcastReceiver() {
            override fun onReceive(context: Context, intent: Intent) {
                ...
                val t = intent.getLongExtra("time", 0)
...
//                        if (!isAPICallingDone) {
                        ...
                        if (!isReminder!!) {
                            val intentReminderActivity =
                                Intent(this@PlayerExoActivity, ReminderActivity::class.java)
                            ...
                            val intentQuotesActivity =
                                Intent(this@PlayerExoActivity, QuotesActivity::class.java)
...
//        TODO("/data/user/0/com.mindfulness.greece/76a86802-8f51-449d-94b2-f8d2f182cbf5.mp3")
    ...
    override fun onBackPressed() {
        super.onBackPressed()
        if (isTaskRoot) {
            val intent = Intent(this@PlayerExoActivity, MainActivity::class.java)
...
//        userMap["dailyMinutes"] = (min + totalDailyMin).toString()
        userMap["totalSessions"] = totalSession.toString()
