...
class PlaySoundActivity : AppCompatActivity(), View.OnClickListener {
...
//                Utils.callUpdateSeconds("",jsonObj)
            ...
            doUnbindService()
//            val intent = Intent(this@PlaySoundActivity, QuotesActivity::class.java)
//            if (momentModel != null) {
...
//                    Utils.callUpdateSeconds("",jsonObj)
    ...
    override fun onBackPressed() {
        ...
        if (isTaskRoot) {
            val intent = Intent(this@PlaySoundActivity, MainActivity::class.java)
            startActivity(intent)
        }
    }
