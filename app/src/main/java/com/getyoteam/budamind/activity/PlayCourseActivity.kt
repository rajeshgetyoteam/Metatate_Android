...
//
//class PlayCourseActivity : AppCompatActivity(), View.OnClickListener,
...
//        val gson = Gson()
//        val jsonChapter = mMyPrefManager!!.chapterModel
//        val jsonCourse = mMyPrefManager!!.courseModel
//        val jsonMeditation = mMyPrefManager!!.meditationState
...
//
//        seekBar.getThumb()
//            .setColorFilter(resources.getColor(R.color.color_icon_light), PorterDuff.Mode.SRC_IN);
//
...
//    ) {
//
//        ivPlay.setColorFilter(
//            resources.getColor(colorCardYellow),
//            PorterDuff.Mode.SRC_IN
//        )
//        ivPause.setColorFilter(
//            resources.getColor(colorCardYellow),
//            PorterDuff.Mode.SRC_IN
//        );
...
////        seekBar.getThumb().setColorFilter(resources.getColor(colorCardYellow), PorterDuff.Mode.SRC_IN);
//
////        seekBar.getProgressDrawable().setColorFilter(colorCardYellow, PorterDuff.Mode.SRC_IN);
////        seekBar.thumb.setColorFilter(colorCardYellow, PorterDuff.Mode.SRC_IN);
//
//
//        progressBar.indeterminateDrawable.setColorFilter(
//            ContextCompat.getColor(this,colorCardEbb96b),
//            PorterDuff.Mode.SRC_IN
//        )
//
//
