...
class PlayTaskMomentsActivity : AppCompatActivity(), View.OnClickListener {
...
//                    jsonObj.put("chapterId", chapterId)
            ...
            val intent = Intent(this@PlayTaskMomentsActivity, QuotesActivity::class.java)
            if (momentModel != null) {
...
//        totalWeeklyMin = meditationStateModelTemp.getWeeklyMinutes() as Int
        ...
        song_progressbar!!.getThumb()
            .setColorFilter(resources.getColor(R.color.app_yellow_color), PorterDuff.Mode.SRC_IN);
...
//                    jsonObj.put("chapterId", chapterId)
    ...
    override fun onBackPressed() {
        ...
        if (isTaskRoot) {
            val intent = Intent(this@PlayTaskMomentsActivity, MainActivity::class.java)
            startActivity(intent)
        }
    }
